...
### ระบบที่ 4: ระบบการคราฟต์ (Crafting System)

#### วัตถุประสงค์:

พัฒนาระบบ **การคราฟต์** ที่รองรับการคราฟต์ได้ทั้งแบบทันที (Instant Crafting) จากแถบ Inventory และการคราฟต์ผ่านสถานีคราฟต์ (Station Crafting) ที่ตำแหน่งเฉพาะในเกม



###  รายละเอียดงานที่ยังไม่เสร็จสิ้น:

1.  **การคราฟต์ทันที (Instant Crafting):**
    -   ผู้เล่นสามารถคราฟต์ไอเทมได้โดยตรงจาก **Inventory Bar** หากมีทรัพยากรที่จำเป็นครบ
    -   ผู้เล่นสามารถคราฟต์ไอเทมได้จากสถานีคราฟต์ , โต๊ะคราฟ์ ที่ถูกกำหนดภายในเกม
...
1.  **การเลือกใช้ไอเทมประเภท Useable (ยา, ของกิน):**
    -   ต้องสร้างการเชื่อมต่อระหว่างไอเทมกับระบบ HP หรือ AP
    -   ประมาณเวลา: **1-2 ชั่วโมง**
        -   สร้างฟังก์ชันการใช้ไอเทม และตรวจสอบว่าผู้เล่นมีไอเทมเหลืออยู่ใน Inventory
        -   เชื่อมต่อกับระบบการฟื้นฟู HP หรือ AP เมื่อใช้ไอเทม

### ระบบที่ 2: ระบบการต่อสู้ (Combat System)

1.  **แถบ HP และ AP ของตัวละครหลัก:**
    
    -   สร้างแถบสุขภาพ (HP) และพลังงาน (AP) ให้กับตัวละครหลัก
    -   ประมาณเวลา: **1.5-2 ชั่วโมง**
        -   รวมถึงการสร้าง UI แสดง HP และ AP และฟังก์ชันการลด HP/AP เมื่อโดนโจมตี
2.  **คำนวณค่าความเสียหายต่อการโจมตี 1 ครั้ง:**
    
    -   ต้องคำนวณค่าความเสียหายที่ตัวละครได้รับต่อการโจมตี
    -   ประมาณเวลา: **1-2 ชั่วโมง**
        -   กำหนดค่าความเสียหายที่ศัตรูสร้างขึ้น และลด HP ของผู้เล่น
3.  **รีเซตพลังชีวิตเมื่อไม่อยู่ในการต่อสู้หรือเสียชีวิต:**
    
    -   ฟังก์ชันรีเซต HP/AP เมื่อผู้เล่นตายหรือออกจากพื้นที่ต่อสู้
    -   ประมาณเวลา: **1-1.5 ชั่วโมง**
4.  **ระบบ HP ของ Slime และการแตกตัว:**
    
    -   ระบบ HP สำหรับศัตรู Slime และการแบ่งตัวเป็น Slime เล็กหลังจากพ่ายแพ้
    -   ประมาณเวลา: **2 ชั่วโมง**
        -   รวมถึงการตั้งค่า HP สำหรับ Slime และสร้าง Slime เล็กเมื่อ Slime หลักพ่ายแพ้
...
1.  **การคราฟต์ทันที (Instant Crafting):**
    ...
    -   ฟังก์ชันการคราฟต์ไอเทมจาก Inventory Bar โดยตรง
    -   ประมาณเวลา: **1-2 ชั่วโมง**
        -   รวมถึงการตรวจสอบทรัพยากรใน Inventory และการสร้างไอเทมทันที
2.  **การคราฟต์ผ่านสถานีคราฟต์:**
    
    -   ระบบที่อนุญาตให้ผู้เล่นคราฟต์ไอเทมเฉพาะในสถานีคราฟต์ที่กำหนด
    -   ประมาณเวลา: **1-3 ชั่วโมง**
        -   รวมถึงการสร้างระบบตรวจสอบว่าผู้เล่นอยู่ในสถานีคราฟต์ที่ถูกต้อง
        
### ประมาณเวลารวม:
-   ระบบ Inventory: **1-2 ชั่วโมง**
-   ระบบการต่อสู้: **5.5-7.5 ชั่วโมง**
-   ระบบการคราฟต์: **2-5 ชั่วโมง**

รวมทั้งหมด: ประมาณ **8.5-14 ชั่วโมง**

***หมายเหตุ เวลาที่ใช้ในแต่ละ task จะรวมไปถึงการเทส , debug , การปรับจูนค่าต่างๆให้สอดคล้องกันภายในเกม , หา Asset , ปรับฟังชันให้สอดคล้องกับฟังชันก่อนหน้า 
